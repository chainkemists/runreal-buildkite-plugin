...
@test "uses correct url for windows platform" {
  ...
  assert_output --partial "https://github.com/chainkemists/runreal/releases/download/v1.0.0/runreal-win-x64.exe"
}
...
@test "uses correct url for linux platform" {
  ...
  assert_output --partial "https://github.com/chainkemists/runreal/releases/download/v1.0.0/runreal-linux-x64"
}
...
@test "uses correct url for macos platform" {
  ...
  assert_output --partial "https://github.com/chainkemists/runreal/releases/download/v1.0.0/runreal-macos-arm"
}
